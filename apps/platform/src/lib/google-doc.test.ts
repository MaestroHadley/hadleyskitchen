...
describe("premium Google Doc model", () => {
  const sections: ReportSection[] = [
    ...
    { title: "Shopping List", rows: [["Ingredient", "Exact grams", "Exact lb + oz", "Buffered grams", "Buffered lb + oz", "Packages to buy"], ["Organic AP Flour", 48401, "106 lb 11.2 oz", 53241, "117 lb 5.8 oz", ""]] },
